...
import { Bollard } from "../database/index.js";
import { MqttPacket } from "./types.js";
import { telemetryCache, pendingAcks, generateMsgId } from "./cache.js";
 ...
 */
export async function handleUplinkMessage(packet: MqttPacket) {
 ...
 */
export async function sendCommandWithAck<T>(sn: string, cmd: number, body: any, timeoutMs = 5000): Promise<T> {
